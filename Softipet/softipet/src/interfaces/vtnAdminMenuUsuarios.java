 ...
 * @author david
 */
public class vtnAdminMenuUsuarios extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnAdminMenuUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
