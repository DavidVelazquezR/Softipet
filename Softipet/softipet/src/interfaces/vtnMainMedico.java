 ...
 * @author david
 */
public class vtnMainMedico extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnMainMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
