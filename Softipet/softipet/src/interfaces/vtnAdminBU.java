 ...
 * @author david
 */
public class vtnAdminBU extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(vtnAdminBU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
