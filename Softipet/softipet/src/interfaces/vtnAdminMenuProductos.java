 ...
 * @author david
 */
public class vtnAdminMenuProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBAll.setBorder(null);
        jBAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBAllActionPerformed(evt);
            }
        });
        jPanel1.add(jBAll, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 40, 100, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnAdminMenuProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
